...
const Island = ({ isRotating, setIsRotating, setCurrentStage,...props }) => {
  ...
  const handlePointerMove = (e) => {
    ...
    if (isRotating) {
      ...
      islandRef.current.rotation.y += delta * 0.01 * Math.PI; // Keliling Lingkaran vertikal
      lastX.current = clientX;
      rotationSpeed.current = delta * 0.01 * Math.PI;
    }
  };

  // Handle user press right and left key
  ...
  // Dipanggil di setiap frame dari @react-three/fiber
  useFrame(() => {
    if (!isRotating) {
